[![MLOPs Python Cookbook with Github Actions](https://github.com/AhmedBnKhalil/Python-MLOps-Cookbook/actions/workflows/pythonapp.yml/badge.svg)](https://github.com/AhmedBnKhalil/Python-MLOps-Cookbook/actions/workflows/pythonapp.yml)
